...
EmberUI = Ember.Namespace.create(), EmberUI.Register = Ember.Mixin.create({
    ...
    computedWidth: function() {
        ...
        return "width: " + (this.get("width") || a[this.get("size")] || a.medium);
    }.property("type", "size")
...
}), this.Ember.TEMPLATES["components/eui-input"] = Ember.Handlebars.template(function(a, b, c, d, e) {
    this.compilerInfo = [ 4, ">= 1.0.0" ], c = this.merge(c, Ember.Handlebars.helpers), 
    e = e || {};
    var f, g, h, i, j = "", k = c.helperMissing, l = this.escapeExpression;
    return e.buffer.push('<div class="eui-wrapper">\n  '), g = {
        value: b,
        name: b,
        pattern: b,
        ...
        hashTypes: h,
        data: e
    }, e.buffer.push(l((f = c.input || b.input, f ? f.call(b, i) : k.call(b, "input", i)))), 
    e.buffer.push("\n</div>\n"), j;
});